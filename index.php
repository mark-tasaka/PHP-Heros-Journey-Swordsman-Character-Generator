...
<html>
<head>
<title>Launch Page: The Hero's Journey 2e Swordsman Character Generator Version 3</title>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="The Hero's Journey 2e Swordsman Character Generator Version 3" class="image" /></h1>
        ...
        <p><a href="https://www.oldschooladventures.org/hero/more/classes/swordsman/"  class="text_link" target="_blank"><span class="bold">Humble Beginnings and Bold Adventures: A Hero's Journey Fan Site</span></a></p>
        ...
        <form action="" id ="SwordsmanFormV3"  target="_blank" method="post">
    ...
    <span class="formIputDescription">Shield:</span>	
			  <select id="shieldV3" name="theShield" class="alignmentBox">			
                <option value="0" selected>No Shield</option>
    ...
    <br/>
        ...
        $("#generate_charactersWarriorV3").click(function(){
         ...
         $("#SwordsmanFormV3").attr('action', "character/hjSwordsman.php");
